...
class TestDigestComputer:
    ...
    def test_get_issue_surges(self, populated_db):
        ...
        with computer._connect() as conn:
            surges = computer._get_issue_surges(conn, week_start, prev_week_start, limit=5)
    ...
    def test_compute_digest_no_data(self, temp_db, temp_state_dir):
        ...
        assert "No fresh lobbying activity detected" in result or "LobbyLens Daily Digest" in result
