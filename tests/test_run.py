...
class TestMainCommand:
    ...
    @patch('bot.run.settings')
    def test_main_dry_run(self, mock_settings, mock_create_notifier, mock_fetch_data, mock_compute_digest):
    ...
    @patch('bot.run.create_notifier')
    @patch('bot.run.settings')
    def test_main_skip_fetch(self, mock_settings, mock_create_notifier, mock_fetch_data, mock_compute_digest):
    ...
    @patch('bot.run.create_notifier')
    @patch('bot.run.settings')
    def test_main_send_notification(self, mock_settings, mock_create_notifier, mock_fetch_data, mock_compute_digest):
    ...
    @patch('bot.run.create_notifier')
    @patch('bot.run.settings')
    def test_main_notification_error(self, mock_settings, mock_create_notifier, mock_fetch_data, mock_compute_digest):
    ...
    @patch('bot.run.create_notifier')
    @patch('bot.run.settings')
    def test_main_with_fetch_errors(self, mock_settings, mock_create_notifier, mock_fetch_data, mock_compute_digest):
        ...
        assert "Errors during processing" in sent_message or "Test digest" in sent_message
