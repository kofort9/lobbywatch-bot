...
class AlertManager:
    ...
    def send_etl_error_alert(self, etl_result: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            timestamp = etl_result.get('timestamp', datetime.now(timezone.utc).isoformat())
    ...
    def send_operational_alert(self, title: str, message: str, severity: str = "warning") -> bool:
    ...
    def _format_etl_alert(self, mode: str, added: int, updated: int, errors: int, 
                         first_error: str, timestamp: str) -> str:
