...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description='LobbyLens v2 - Enhanced Government Signals Bot')
    parser.add_argument('--mode', choices=['daily', 'mini', 'test', 'quarterly', 'server'], 
                       default='daily', help='Run mode')
    parser.add_argument('--hours', type=int, default=24, help='Hours back to collect signals')
    parser.add_argument('--channel', type=str, default='test_channel', help='Slack channel ID')
    parser.add_argument('--port', type=int, default=8000, help='Web server port')
    parser.add_argument('--dry-run', action='store_true', help='Dry run (no Slack posting)')
