...
class DeploymentValidator:
    ...
    def validate_environment(self) -> bool:
        ...
        if bot_token and not bot_token.startswith('xoxb-') and bot_token != 'test_token':
    ...
    def validate_database(self) -> bool:
        ...
        try:
            ...
            success = db_manager.add_to_watchlist('test', 'client', 'Test Corp', 'Test Corp')
    ...
    def validate_web_server(self) -> bool:
        ...
        try:
            ...
            with app.test_client() as client:
                ...
                challenge_response = client.post('/lobbylens/events',
    ...
    def validate_security(self) -> bool:
        ...
        if not signing_secret:
            self.warnings.append("SLACK_SIGNING_SECRET not set - signature verification disabled")
        else:
        ...
        try:
            result = subprocess.run(['grep', '-r', '-i'] + sensitive_patterns + ['bot/'],
                                  capture_output=True, text=True)
            if result.returncode == 0:
                self.warnings.append("Potential secrets found in code - ensure they're in environment variables")
        except:
