...
def main():
    ...
    test_parser.add_argument("--pages", type=int, default=1, help="Number of pages to fetch")
    ...
    if args.command == "update":
        ...
        try:
            filings = scheduler.etl._fetch_filings_by_type(2024, "Q3", max_pages=args.pages)
